...
(function ($) {
    ...
    api = DhTreeFolder = {
        ...
        setIcons: function () {
            ...
            $(document).on('click', '.dh-tree-icon.has_children', function (event) {
