...
class FileBird_Feedback{
    public function __construct(){
        add_action( 'admin_enqueue_scripts', [ $this, 'enqueue_filebird_feedback' ] );
    }
    ...
    public function enqueue_filebird_feedback(){
        ...
        add_action( 'admin_footer', [ $this, 'form_feedback' ] );
    ...
    public function form_feedback(){
        ...
        <?php endforeach;?>
            ...
            <div class="filebird-feedback-action">
                <button class="button button-primary" id="feedback-submit"><?php echo __( 'Submit and Deactive', NJT_FILEBIRD_TEXT_DOMAIN )?></button>
                <button id="feedback-skip"><?php _e( 'Skip and Deactive', NJT_FILEBIRD_TEXT_DOMAIN )  ?></button>
            </div>
        </div>
    <?php 
    }
