...
if ( ! defined( 'NJT_FILEBIRD_PLUGIN_NAME' ) ) {
	define( 'NJT_FILEBIRD_PLUGIN_NAME', 'FileBird Lite' );
}
...
require plugin_dir_path( __FILE__ ) . 'includes/class-filebird-elementor.php';
require plugin_dir_path( __FILE__ ) . 'includes/filebird-cores.php';
require plugin_dir_path( __FILE__ ) . 'includes/class-filebird-feedback.php';
...
function filebird_run() {
	...
	$elementor = new FileBird_Elementor();
	$elementor->init();
