    ...
    if (!wp_verify_nonce($nonce, 'image_hover_ultimate_home_export')) {
        ...
        if (is_plugin_active('shortcode-addons/index.php')) {
            ...
            $addonsimport = '<div class="alert alert-danger">
                                Kindly install <a href="https://wordpress.org/plugins/shortcode-addons/" target="_blank"><strong>Shortcode addons</strong></a> for import Image hover data. At free version also works to import Style Data. You can also import style from demo layouts at Shortcode Addons Import Style..
                            </div>';
        }
