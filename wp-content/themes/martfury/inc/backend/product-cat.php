...
class Martfury_Product_Cat {
	...
	function add_category_fields() {
        ...
        <div class="form-field mf-cat-banners-group">
            ...
            <div id="mf_cat_banners" class="mf-cat-banners">
                ...
                <input type="hidden" class="mf_cat_banners_id" name="mf_cat_banners_id"/>
	...
	function edit_category_fields( $term ) {
		...
		$thumbnail_ids     = $banners_link = $cat_layout = $cat_sidebar = '';
		$product_cat_1_els = $product_cat_2_els = $product_cat_3_els = '';
		if ( function_exists( 'get_woocommerce_term_meta' ) ) {
			$thumbnail_ids     = absint( get_woocommerce_term_meta( $term->term_id, 'mf_cat_banners_id', true ) );
			$banners_2_ids     = absint( get_woocommerce_term_meta( $term->term_id, 'mf_cat_banners_2_id', true ) );
			$banners_link      = get_woocommerce_term_meta( $term->term_id, 'mf_cat_banners_link', true );
			$banners_2_link    = get_woocommerce_term_meta( $term->term_id, 'mf_cat_banners_2_link', true );
			$cat_layout        = get_woocommerce_term_meta( $term->term_id, 'mf_cat_layout', true );
			$cat_sidebar       = get_woocommerce_term_meta( $term->term_id, 'mf_cat_sidebar', true );
			$product_cat_1_els = get_woocommerce_term_meta( $term->term_id, 'product_cat_1_els', true );
			$product_cat_2_els = get_woocommerce_term_meta( $term->term_id, 'product_cat_2_els', true );
			$product_cat_3_els = get_woocommerce_term_meta( $term->term_id, 'product_cat_3_els', true );
	...
	function save_category_fields( $term_id, $tt_id = '', $taxonomy = '' ) {
		...
		if ( 'product_cat' === $taxonomy && function_exists( 'update_woocommerce_term_meta' ) ) {
			if ( isset( $_POST['mf_cat_banners_id'] ) ) {
				update_woocommerce_term_meta( $term_id, 'mf_cat_banners_id', absint( $_POST['mf_cat_banners_id'] ) );
			}

			if ( isset( $_POST['mf_cat_banners_link'] ) ) {
				update_woocommerce_term_meta( $term_id, 'mf_cat_banners_link', $_POST['mf_cat_banners_link'] );
			}

			if ( isset( $_POST['mf_cat_banners_2_id'] ) ) {
				update_woocommerce_term_meta( $term_id, 'mf_cat_banners_2_id', absint( $_POST['mf_cat_banners_2_id'] ) );
			}

			if ( isset( $_POST['mf_cat_banners_2_link'] ) ) {
				update_woocommerce_term_meta( $term_id, 'mf_cat_banners_2_link', $_POST['mf_cat_banners_2_link'] );
			}

			if ( isset( $_POST['mf_cat_layout'] ) ) {
				update_woocommerce_term_meta( $term_id, 'mf_cat_layout', $_POST['mf_cat_layout'] );
			}

			if ( isset( $_POST['mf_cat_sidebar'] ) ) {
				update_woocommerce_term_meta( $term_id, 'mf_cat_sidebar', $_POST['mf_cat_sidebar'] );
			}
			...
			update_woocommerce_term_meta( $term_id, 'product_cat_1_els', $els_1 );
			...
			update_woocommerce_term_meta( $term_id, 'product_cat_2_els', $els_2 );

			$els_3 = array();
			if ( isset( $_POST['product_cat_3_els'] ) ) {
				$els_3 = $_POST['product_cat_3_els'];
			}
			update_woocommerce_term_meta( $term_id, 'product_cat_3_els', $els_3 );
		}
	}
