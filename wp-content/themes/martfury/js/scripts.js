(function ($) {
    ...
    martfury.navigationMobile = function () {
        ...
        martfury.$header.on('click', '#site-header-category--mobile', function (e) {
            ...
            $cats.addClass('current');
            $els.addClass('open');
            $('#mf-els-modal-mobile.not-cat-navigation').addClass('has-header-cat');
            $('#mf-navigation-mobile').find('.navigation-mobile_cat').addClass('active');
    ...
    martfury.productsLoadInfinite = function () {
        ...
        martfury.$body.on('click', '.woocommerce-pagination .next', function (e) {
            ...
            if (martfury.$body.hasClass('wcfm-store-page')) {
                $products = $pagination.prev('#mf-shop-content').find('.products');
            }
    ...
    martfury.catalogSorting = function () {
        ...
        $sortingMobile.on('click', '.mf-cancel-order', function (e) {
            e.preventDefault();
